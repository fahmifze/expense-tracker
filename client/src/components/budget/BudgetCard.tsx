    ...
    <div className="card p-4 space-y-4">
      ...
      {(budget.isWarning || budget.isOverBudget) && (
        <div className={`p-2 rounded-lg text-sm ${
          budget.isOverBudget ? 'bg-red-50 dark:bg-red-900/30 text-red-700 dark:text-red-400' : 'bg-yellow-50 dark:bg-yellow-900/30 text-yellow-700 dark:text-yellow-400'
        }`}>
          {budget.isOverBudget
            ? 'Budget exceeded!'
